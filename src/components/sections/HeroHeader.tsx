...
const LeetCodeIcon = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226l-3.854 4.126a5.266 5.266 0 0 0-1.209 2.104 5.35 5.35 0 0 0-.125.513 5.527 5.527 0 0 0 .062 2.362 5.83 5.83 0 0 0 .349 1.017 5.938 5.938 0 0 0 1.271 1.818l4.277 4.193.039.038c2.248 2.165 5.852 2.133 8.063-.074l2.396-2.392c.54-.54.54-1.414.003-1.955a1.378 1.378 0 0 0-1.951-.003l-2.396 2.392a3.021 3.021 0 0 1-4.205.038l-.02-.019-4.276-4.193c-.652-.64-.972-1.469-.948-2.263a2.68 2.68 0 0 1 .066-.523 2.545 2.545 0 0 1 .619-1.164L9.13 8.114c1.058-1.134 3.204-1.27 4.43-.278l.014.013c.398.36.837.677 1.227.986l.13.104a1.38 1.38 0 0 0 1.955-.003c.54-.54.54-1.414-.003-1.955a18.65 18.65 0 0 1-.344-.291l-.227-.19a4.71 4.71 0 0 0-.107-.088l-.033-.027-.014-.013a5.954 5.954 0 0 0-2.692-1.545L13.483 0zM8.15 18.545a1.374 1.374 0 0 0 0 1.955 1.374 1.374 0 0 0 1.955 0l6.263-6.357a1.374 1.374 0 0 0 0-1.955 1.374 1.374 0 0 0-1.955 0l-6.263 6.357z" />
  </svg>
);
